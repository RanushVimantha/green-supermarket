...
img {
	...
	margin: 0 auto;
		...
		<form id="contact" action="fansMessage" method="post">
			...
			<fieldset>
				<textarea placeholder="Type your message here...." name="comments" tabindex="5"
					required></textarea>
			</fieldset>
			<fieldset>
	...
	<div class="faq-container">
		...
		<br>
		<h2 style="color: #5b615b;">1. Q: Is it safe to shop on your
			online platform?</h2>
		<p style="color: rgb(64, 61, 61);">A: Yes, we prioritize the
			security of your information with robust encryption and secure
			payment gateways.</p>
		<br>

		<h2 style="color: #5b615b;">2. Q: What payment options are
			available?</h2>
		<p style="color: rgb(47, 45, 45);">A: We accept various payment
			methods, including credit/debit cards, PayPal, and other secure
			payment options.</p>
		<br>

		<h2 style="color: #5b615b;">3. Q: How can I track my order?</h2>
		<p style="color: rgb(47, 45, 45)">A: Once your order is shipped,
			you'll receive a tracking number via email to monitor the delivery
			status.</p>

		<br>
		<h2 style="color: #5b615b;">4. Q: Can I modify or cancel my order
			after placing it?</h2>
		<p style="color: rgb(47, 45, 45)">A: Unfortunately, once an order
			is confirmed, modifications or cancellations may not be possible.
			Please review your order carefully.</p>
		<br>
		<h2 style="color: #5b615b;">5. Q: What is your return policy?</h2>
		<p style="color: rgb(47, 45, 45)">A: We have a hassle-free return
			policy within a specified period. Visit our Returns page for detailed
			information on initiating returns.</p>
		<br>
	</div>
