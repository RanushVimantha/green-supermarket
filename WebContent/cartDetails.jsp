            ...
            <div class="CartContainer" style="margin-top: 130px; margin-bottom: 35px">
				...
				%>
                        ...
                        <div class="Cart-Items">
                            <div class="image-box">
                                <img src="./ShowImage?pid=<%=product.getProdId()%>" style="height : 120px;"/>
                            </div>
                            <div class="about">
                                <h1 class="title">
                                    <%=product.getProdName()%>
                            ...
                            <div class="prices">
                                <div class="amount" style="opacity: 40%; font-size: 1.2em;">Rs. <%=product.getProdPrice()%>
                                </div>
                                <div class="amount">Rs. <%=currAmount%>
                                </div>
                            </div>
                ...
                <form method="post">
                    <button class="button" formaction="payment2.jsp?amount=<%=totAmount%>">Checkout</button>
